    ...
    <div className="w-full relative px-5">
      ...
      {timelineData.map((item, index) => (
        <div className={`flex ${item.rowClass}`} key={index}>
          <div className="timeline-card relative bg-white p-5 shadow-lg hover:shadow-2xl rounded-xl mb-4 transition-shadow before:absolute before:content-[''] before:h-[15px] before:w-[15px] before:bg-white before:top-8 before:-z-[1] before:rotate-45 group">
